...
struct MySolution {
    ...
    std::string to_string() const { return "{x:" + std::to_string(x) + ", y:" + std::to_string(y) + "}"; }
};
...
public:
    ...
    void SO_report_generation(
        ...
        output_file << generation_number << "\t" << best_genes.x << "\t" << best_genes.y << "\t"
                    << last_generation.average_cost << "\t" << last_generation.best_total_cost << "\n";
    }
};
